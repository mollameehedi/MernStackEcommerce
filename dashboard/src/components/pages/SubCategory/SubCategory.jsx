...
let handleDelete = async(id) =>{
  setLoading(id)
  let userData = await  axios.post('http://127.0.0.1:8000/api/v1/product/deletesubcategory',{id:id})
...
const onFinishModal = async (values) => {
  await  axios.post('http://127.0.0.1:8000/api/v1/product/editsubcategory',{
    name:values.name,
    id:editId
  })
  .then((respone) =>{
...
useEffect(() =>{
  let data = [];
  async function user(){
  let userData = await  axios.get('http://127.0.0.1:8000/api/v1/product/allsubcategory')
